...
Now that we've [downloaded the data](https://github.com/simonpcouch/gwc-bmore-2022/blob/master/source/grad_data.md), we can analyze it to get at these questions.
